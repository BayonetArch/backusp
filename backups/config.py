...
keys = [
 ...
 Key([], "XF86AudioRaiseVolume", lazy.spawn("pactl set-sink-volume @DEFAULT_SINK@ +10%")),
    ...
    Key([mod],"y",lazy.spawn("thorium-browser --app=https://youtube.com")),
Key([mod,"shift"],"g",lazy.spawn("thorium-browser --app=https://gemini.google.com/app/5fb6e27b210e7a42")),
Key([mod,"shift"],"l",lazy.spawn("galculator")),
Key([mod],"g",lazy.spawn("geany")),
Key([mod,"shift"],"c",lazy.spawn ("thorium-browser --app=https://chat.openai.com")),
